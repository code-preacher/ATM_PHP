        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55"><?php $lib->msg();?><br/>
                <form action="#" method="post" class="login100-form validate-form flex-sb flex-w">
                    ...
                    <div class="wrap-input100 validate-input m-b-12" data-validate = "ACCOUNT NUMBER is required">
                        <input class="input100" type="number" name="acc" required="required" placeholder="RECIEVER ACCOUNT NUMBER">
                        <span class="focus-input100"></span>
                    </div>

                     <div class="wrap-input100 validate-input m-b-12" data-validate = "AMOUNT is required">
                        <select class="input100" required="required">
                             <option>FCMB</option>
                     ...
                     <div class="wrap-input100 validate-input m-b-12" data-validate = "AMOUNT is required">
                        <input class="input100" type="number" name="amount" required="required" placeholder="AMOUNT">
                        <input class="input100" type="hidden" name="ano" value="<?=$_GET['ano']?>">
                        <span class="focus-input100"></span>
                    </div>

                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" type="submit" name="pay">
                          TRANSFER
                        </button>
                    </div>
<br/><br/><br/>
