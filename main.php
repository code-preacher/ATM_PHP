...
<div class="col-md-12">
 <a href="withdraw.php?ano=<?=$_GET['ano']?>" class="btn btn-primary col-md-12">
                               Withdraw
                            </a>
</div> 
<br><br>
...
<div class="col-md-12">
 <a href="transfer.php?ano=<?=$_GET['ano']?>" class="btn btn-warning col-md-12">
                               Transfer
                            </a>
</div> 
...
<div class="col-md-12">
 <a href="account_info.php?ano=<?=$_GET['ano']?>" class="btn btn-success col-md-12">
                               Check Account Info
                            </a>
</div> 
