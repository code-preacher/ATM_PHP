	...
	<header>
		<div class="container">
			...
			<div class="w3layouts-login">
					<a  href="verify.php"><i class="glyphicon glyphicon-log-in"> </i>&nbsp;Click Continue to Proceed</a> <a  href="login.php"><i class="glyphicon glyphicon-log-in"> </i>&nbsp;Admin Login</a> 
			</div>    
